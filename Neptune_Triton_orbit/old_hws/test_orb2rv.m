...
[~,e,i,O,o,nu,~,~,~,p] =rv2orb_OG(pos,vel);
[r,v] = orb2rv_OG(p,e,i,O,o,nu);

%Start w/ a position and velocity vector of a circular orbit
pos = [6524.834,0,0]';
vel = [0,7.81599286557539,0]';
%Convert to keplerian orbital elements
[a,e,i,O,o,nu,truLon,argLat,lonPer,p] =rv2orb_OG(pos,vel);
[r,v] = orb2rv_OG(p,e,i,O,o,nu,truLon,argLat,lonPer);
...
%elements
[r,v] = orb2rv_OG(10000,1.0,pi/2,0,0,0,0,0,0);
[a,e,i,O,o,nu,truLon,argLat,lonPer,p] =rv2orb_OG(r,v);
